...
type CryptoCurrencyRepository interface {
	GetMostVoted() (*CryptoCurrency, error)
	GetById(id int64) (*CryptoCurrency, error)
	Save(cc *CryptoCurrency) (*CryptoCurrency, error)
	Update(cc *CryptoCurrency) (*CryptoCurrency, error)
	Delete(id int64) (*CryptoCurrency, error)
	UpVote(id int64) (*CryptoCurrency, error)
	DownVote(id int64) (*CryptoCurrency, error)
}
...
func (r *Repository) GetMostVoted() (*CryptoCurrency, error) {
	err := db.Ping()
...
func (r *Repository) GetById(id int64) (*CryptoCurrency, error) {
	err := db.Ping()
	utils.CheckError(err)
...
func (r *Repository) Save(cc *CryptoCurrency) (*CryptoCurrency, error) {
	err := db.Ping()
	utils.CheckError(err)
...
func (r *Repository) Update(cc *CryptoCurrency) (*CryptoCurrency, error) {
	err := db.Ping()
	utils.CheckError(err)
...
func (r *Repository) Delete(id int64) (*CryptoCurrency, error) {
	err := db.Ping()
	utils.CheckError(err)
...
func (r *Repository) UpVote(id int64) (*CryptoCurrency, error) {
	err := db.Ping()
	utils.CheckError(err)
...
func (r *Repository) DownVote(id int64) (*CryptoCurrency, error) {
	err := db.Ping()
	utils.CheckError(err)
